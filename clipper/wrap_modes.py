...
The stored value is a colour name because it is a key in the version-1 session
...
colour cannot.  (An enum was the other option and is not taken here: the loader
