' Rendered from [tool.haglio.launchers."launch_clipper.vbs"] in pyproject.toml.
...
Sub Decide()
  ...
  If fso.FileExists(fso.BuildPath(root, ".venv\Scripts\Clipper-Clipper.exe")) Then interpreter = fso.BuildPath(root, ".venv\Scripts\Clipper-Clipper.exe")
  directory = root
End Sub
